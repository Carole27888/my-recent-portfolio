...
const ExperienceTopLeft = () => {
  return (
    <div className='flex flex-col gap-6 w-full max-w-[300px] sm:max-w-[350px] md:max-w-[300px] mx-auto px-4'>
        ...
        <p className='text-center text-white text-sm sm:text-xs md:text-sm'>With two years of coding under my belt, I've been crafting digital experiences that blend logic with creativity.</p>
