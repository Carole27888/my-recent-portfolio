...
const SingleProject = ({ name, year, align, image, link }) => {
  return (
    <div>
      <div className={`flex w-full sm:flex-col-reverse items-center gap-1 ${
        ...
        <div className="max-h-[220px] max-w-[400px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 relative border border-red">
